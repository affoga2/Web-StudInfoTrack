...
<h1 class="text-center" style="margin-top: 150px">Delete Student Record</h1>
            ...
            <input type="hidden" name="id" value="<?=$record['id'];?>">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <h5 style="text-align: center; background-color: red; border-top-right-radius: 100px; border-top-left-radius: 100px; height: 40px; padding:7px;">Are you sure you want to delete this Data?</h5>
                        <label for="title" class="form-label">Full Name</label>
                        <h5 style="border-color:red;" type="none" class="form-control" id="title" name="delete_fullName"><?=$record['fullName'];?></h5>
